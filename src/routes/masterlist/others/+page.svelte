<script lang="ts">
  ...
  let collectionPath = 'masterlist/others';
  let showModal = false;
  let errorMsg = '';
...
<div class="bg-white rounded-2xl shadow-xl p-8">
  <h1 class="text-2xl font-bold mb-2">Other Name Masterlist</h1>
  <p class="mb-6 text-gray-500">Manage your other names here</p>
