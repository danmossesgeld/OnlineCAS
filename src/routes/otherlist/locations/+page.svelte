<script lang="ts">
  ...
  const subCollectionName = 'locations';
  const collectionPath = 'otherlist/locations';  // This will be mapped to listdatabase/otherlist/locations
  
  // ListContainer configuration
  const documentType = 'location';
  const title = 'Locations';
  const subtitle = 'Manage your business locations and warehouses';
